...
namespace API.Migrations
{
    ...
    [Migration("20221228045532_PasswordAndPassportNumberAreUniqueNow")]
    partial class PasswordAndPassportNumberAreUniqueNow
    {
        /// <inheritdoc />
            ...
            modelBuilder.Entity("API.Models.Person", b =>
                {
                    ...
                    b.HasIndex(new[] { "PassportNumber" }, "person_passport_number_key")
                        .IsUnique();

                    b.HasIndex(new[] { "Password" }, "person_password_key")
                        .IsUnique();
